...
- NAME OURS BY CHAMPION, THEIRS BY SEAT. One of ours is "Vi", "Aphelios", "Nautilus" — never "our Jungle", "our ADC", "our Support". Write "Vi 54s, Aphelios 55s and Nautilus 45s were on the floor", not "our Jungle 54s, ADC 55s and Support 45s". In a player's own note, speak to them as "you" and name their teammates by champion the same way: "your Top died alone" is "Mordekaiser died alone". The other side keeps the seat word — "their ADC was 37s from respawn" is right and must stay, because they have no names here. That asymmetry is the rule doing its job: a seat word on its own means the other team.
