...
| The three lines above, applied to the **post-game review** (8 Sep 2026) | The review is post-game only, over finished games. It reviews **our own players**, by our own names, about our own play; the other team enters the prompt as champions in seats and the validator drops any note about anyone else. Every point is evidence plus a choice or a question, never an order. It stores derived text only. The model provider question is in `docs/ai-provider-note.md`. |
